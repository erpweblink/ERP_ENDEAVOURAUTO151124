<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Customer_PO_Sales.aspx.cs" Inherits="Admin_Customer_PO_Sales" %>
    ...
    <script>
        function HideLabel(msg) {
            Swal.fire({
                ...
                window.location.href = "../Admin/CustomerPO_List_Sales.aspx";
            })
        };
    </script>
    <script>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" runat="server" visible="false">
                                    ...
                                    <asp:TextBox ID="txt_job_no" runat="server"  AutoPostBack="true" CssClass="form-control"></asp:TextBox>
