<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="CustomerPO_Report.aspx.cs" EnableEventValidation="false" Inherits="Admin_CustomerPO_Report" %>
    ...
    <form runat="server">
        ...
        <div class="col-lg-12 card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-primary">Customer PO Report</h5>
            </div>
            <hr />
            <div class="card-body">
                <div class="row text-center">
                    <div class="row">
                        <div class="col-md-2">
                            <asp:Label ID="lblPONo" runat="server" class="control-label col-sm-6 lbljob lblvendorpo"> P.O. No. :</asp:Label>
                            <asp:TextBox runat="server" class="form-control txtjob " ID="txtPONo" name="Search" placeholder="P.O. No." />
                            <asp:AutoCompleteExtender ID="AutoCompleteExtender2" CompletionListCssClass="completionList"
                                CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListItemCssClass="listItem"
                                CompletionInterval="10" MinimumPrefixLength="1" ServiceMethod="GetPONOList" TargetControlID="txtPONo" runat="server">
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:Button ID="btnexportexcel" OnClick="btnexportexcel_Click" runat="server" CssClass="btn btn-primary" Style="margin-top: 10px" Text="Export Excel" />
                        </div>
                    </div>
                    <div style="width: 100%; padding: 20px;">
                        <div class="table-responsive">
                            <asp:GridView ID="gv_PO_List" runat="server" OnRowCommand="gv_PO_List_RowCommand" AutoGenerateColumns="False" CellPadding="3" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Customer Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCompName" runat="server" Text='<%# Eval("CustomerName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="PO. No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblJobNo" runat="server" Text='<%# Eval("Pono") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="PO. Date">
                                        <ItemTemplate>
                                            <%--<asp:Label ID="lblQuNo" runat="server" Text='<%# Convert.ToDateTime( Eval("PoDate","{0:d}")).ToString("dd/MM/yyyy") %>'></asp:Label>--%>
                                            <asp:Label ID="lblQuNo" runat="server" Text='<%# Eval("PoDate","{0:d}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Refrence No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblrefernceno" runat="server" Text='<%# Eval("RefNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Mobile No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lbltotalAmt" runat="server" Text='<%# Eval("Mobileno") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Created Date">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblcreateddate" runat="server" Text='<%# Eval("CreatedOn","{0:d}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkshow" runat="server" Visible="false" CommandName="ShowReport" CommandArgument='<%# Eval("Pono")%>'><i class="fas fa-eye" style="font-size:24px"></i></asp:LinkButton>
                                            <asp:LinkButton runat="server" ID="lnkBtn_View" ToolTip="Generate PDF" CommandArgument='<%# Eval("Id") %>' CommandName="RowView"><i class="fas fa-file-pdf"  style="font-size: 26px; color:red; "></i></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:GridView ID="sortedgv" runat="server" OnRowCommand="gv_PO_List_RowCommand" AutoGenerateColumns="False" CellPadding="3" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center">
                                <Columns>
                                    <asp:TemplateField HeaderText="Sr. No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSrNo" runat="server" Text='<%#Container.DataItemIndex +1 %>'></asp:Label>
