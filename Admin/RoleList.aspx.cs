...
public partial class Admin_RoleList : System.Web.UI.Page
{
    ...
    protected void RoleGrid()
    {
        try
        {
            ...
            SqlDataAdapter sad = new SqlDataAdapter("SELECT  * FROM [tblRole] where isdeleted='0' ", con);
            sad.Fill(dt);
    ...
    protected void gv_Role_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            SqlCommand cmddelete = new SqlCommand("update tblRole set isdeleted='1' where Id=@Id", con);
    ...
    protected void lnkBtnsearch_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Please Search Role Name');", true);
