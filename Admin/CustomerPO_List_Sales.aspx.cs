...
public partial class Admin_CustomerPO_List_Sales : System.Web.UI.Page
{
    ...
    {
        DataTable Dt = new DataTable();
        SqlDataAdapter da = new SqlDataAdapter("SELECT Id,jobNo,Quotationno,CustomerName,SubCustomer,Pono,PoDate,RefNo,Mobileno,GrandTotal,CreatedBy,CreatedOn,DATEDIFF(DAY, PoDate, getdate()) AS days, Type FROM CustomerPO_Hdr_Both WHERE Is_Deleted='0' ORDER BY CreatedOn DESC", con);
        da.Fill(Dt);
    ...
    public void GetSortedDatewisedata()
    {
        ...
        DataTable dtt = new DataTable();
        SqlDataAdapter sad = new SqlDataAdapter("select  Id,CustomerName,SubCustomer,JobNo,Pono,PoDate,RefNo,Mobileno,Quotationno,CreatedBy,GrandTotal,CreatedOn,DATEDIFF(DAY, PoDate, getdate()) AS days from CustomerPO_Hdr_Both where  PoDate between '" + txt_form_podate_search.Text + "'  AND '" + txt_to_podate_search.Text + "' AND Is_Deleted='0'", con);
        sad.Fill(dtt);
    ...
    public void Getsortedquation()
    {
        ...
        DataTable dtt = new DataTable();
        SqlDataAdapter sad = new SqlDataAdapter("select  Id,CustomerName,SubCustomer,JobNo,Pono,PoDate,RefNo,Mobileno,Quotationno,CreatedBy,GrandTotal,CreatedOn,DATEDIFF(DAY, PoDate, getdate()) AS days from CustomerPO_Hdr_Both where  Pono = '" + txt_pono_search.Text + "' AND Is_Deleted='0'", con);
        sad.Fill(dtt);
        GvSorted.EmptyDataText = "Records Not Found";
        GvSorted.DataSource = dtt;
        GvSorted.DataBind();
    ...
    public void Sortedcompony()
    {
        ...
        DataTable dtt = new DataTable();
        SqlDataAdapter sad = new SqlDataAdapter("select  Id,CustomerName,SubCustomer,JobNo,Pono,PoDate,RefNo,Mobileno,Quotationno,CreatedBy,GrandTotal,CreatedOn,DATEDIFF(DAY, PoDate, getdate()) AS days from CustomerPO_Hdr_Both where CustomerName = '" + txtJobno.Text + "' AND  Is_Deleted='0'", con);
        sad.Fill(dtt);
        GvSorted.EmptyDataText = "Records Not Found";
        GvSorted.DataSource = dtt;
        GvSorted.DataBind();
    ...
    protected void ddlservicetype_TextChanged(object sender, EventArgs e)
    {
        GvCustomerpoList.Visible = false;
        DataTable dtt = new DataTable();
        SqlDataAdapter sad = new SqlDataAdapter("select  Id,CustomerName,SubCustomer,JobNo,Pono,PoDate,RefNo,Mobileno,Quotationno,CreatedBy,GrandTotal,CreatedOn,DATEDIFF(DAY, PoDate, getdate()) AS days from CustomerPO_Hdr_Both where  ServiceType ='" + ddlservicetype.Text + "' AND Is_Deleted = '0'", con);
