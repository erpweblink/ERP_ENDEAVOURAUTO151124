<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Quotation_ListSales.aspx.cs" Inherits="Admin_Quotation_ListSales" %>
      ...
      <form runat="server">
        ...
        <div class="col-lg-12 card">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-primary">Quotation List Sales</h5>
            </div>
            <hr />
            <div class="card-body">
                <div class="row">
