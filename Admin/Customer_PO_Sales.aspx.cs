...
public partial class Admin_Customer_PO_Sales : System.Web.UI.Page
{
    ...
    private void Load_Record()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select CustomerPO_Dtls_Sales.JobNo,CustomerPO_Dtls_Sales.MateName,CustomerPO_Dtls_Sales.PrintDescription,CustomerPO_Dtls_Sales.Quotationno,CustomerPO_Hdr_Sales.Id,CustomerPO_Hdr_Sales.JobNo,CustomerPO_Hdr_Sales.ShippingAddress,CustomerName,SubCustomer,Pono,PoDate,RefNo,Mobileno,KindAtt,DeliveryAddress,EmailId,GstNo,VehicelNo,PayTerm,Cgst,Sgst,Igst,AllTotalPrice,TotalInWord, RoundOff,AgainstBy, GrandTotal, Term_Condition_1, Term_Condition_2, Term_Condition_3, Term_Condition_4,Term_Condition_5,Term_Condition_6, Description, Hsn_Sac,Rate,Unit,Quantity, TaxPercenteage, DiscountPercentage, Total,statecode,Imagepath from CustomerPO_Hdr_Sales INNER JOIN CustomerPO_Dtls_Sales ON CustomerPO_Hdr_Sales.Id = CustomerPO_Dtls_Sales.PurchaseId WHERE CustomerPO_Hdr_Sales.Id='" + ID + "'", con);
        da.Fill(Dt);
        ...
        else
        {
            try
            {
                ...
                foreach (GridViewRow g1 in gvPurchaseRecord.Rows)
                {
                    ...
                    SqlCommand Cmd1 = new SqlCommand("INSERT INTO CustomerPO_Dtls_Sales (PurchaseId,Hsn_Sac,TaxPercenteage,Quantity,Unit,Rate,DiscountPercentage,Total,PrintDescription,MateName,Quotationno) " +
