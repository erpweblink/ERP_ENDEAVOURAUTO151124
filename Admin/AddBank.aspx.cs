...
public partial class Admin_AddBnak : System.Web.UI.Page
{
    ...
    protected void loadData(string id)
    {
        try
        {
            SqlDataAdapter sad = new SqlDataAdapter("SELECT * FROM tbl_Bank  where id='" + id + "'", con);
        ...
        try
        {
            if (btnSubmit.Text == "Submit")
            {
                ...
                else
                {
                    ...
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "alert", "HideLabel('Data Saved Sucessfully','1');", true);
                    }
                }
            }
            else if (btnSubmit.Text == "Update")
            {
                ...
                if (Request.QueryString["Name"] != null)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "alert", "HideLabel('Bank Update Sucessfully','0');", true);
                }
                else
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "alert", "HideLabel('Bank Update Sucessfully','1');", true);
                }
            }
        }
        catch (Exception)
