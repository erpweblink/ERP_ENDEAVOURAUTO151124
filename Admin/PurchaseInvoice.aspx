...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="PurchaseInvoice.aspx.cs" Inherits="Admin_PurchaseInvoice" %>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header  py-3 d-flex flex-row align-items-center justify-content-between">
                    <h5 class="m-0 font-weight-bold text-primary" id="headerreport" runat="server">Purchase Invoice</h5>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <asp:Label ID="lblvocNo" runat="server" class="control-label col-sm-6" for="cust">Voc. No. :<span class="spncls">*</span></asp:Label>
                                    <asp:TextBox ID="txtVocNo" AutoPostBack="true" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="lblvocDate" runat="server" Text="" Class="control-label col-sm-6" for="cust">Voc. Date :<span class="spncls">*</span></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Label ID="lbl_Invoice_no" runat="server" class="control-label col-sm-6" for="cust">Supplier Invoice No. :<span class="spncls"></span></asp:Label>
                                    <asp:TextBox ID="txt_InvoiceNo"  runat="server" CssClass="form-control"></asp:TextBox>
                                    <%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter InvoiceNo" ControlToValidate="txt_InvoiceNo" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
                                <div class="col-md-6">
                                    <asp:Label ID="lblinvoicedate" runat="server" Text="" Class="control-label col-sm-6" for="cust">Supplier Invoice Date :<span class="spncls">*</span></asp:Label>
                                    <asp:TextBox ID="txtinvoicedate" TextMode="Date" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Date" ControlToValidate="txtinvoicedate" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Label ID="lblchallanno" runat="server" class="control-label col-sm-6" for="cust">Supplier Challan No. :<span class="spncls"></span></asp:Label>
                                    <asp:TextBox ID="txtchallanno"  runat="server" CssClass="form-control"></asp:TextBox>
                                    <%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter InvoiceNo" ControlToValidate="txt_InvoiceNo" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
                                <div class="col-md-6">
                                    <asp:Label ID="Llblchallandate" runat="server" Text="" Class="control-label col-sm-6" for="cust">Supplier Challan Date :<span class="spncls">*</span></asp:Label>
                                    <asp:TextBox ID="txtchallandate" TextMode="Date" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Enter Date" ControlToValidate="txtorderdate" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="lblcompname" runat="server" class="control-label col-sm-6" for="cust">Supplier Name :<span class="spncls">*</span></asp:Label>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please Enter Supplier Name" ControlToValidate="txtCompName" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:TextBox ID="txtmobileno" runat="server" TextMode="MultiLine" CssClass="form-control" onkeypress="return isNumberKey(event)" MaxLength="11"></asp:TextBox>
                            ...
                            <div class="row" id="invoice">
                                <div class="table-responsive text-center">
                                    <asp:GridView ID="gvPurchaseRecord" runat="server" AutoGenerateColumns="false" CssClass="grid" AllowPaging="false" Width="100%" OnRowEditing="gvPurchaseRecord_RowEditing" OnRowDataBound="gvPurchaseRecord_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Sr. No.">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <EditItemTemplate>
                                                    <asp:LinkButton ID="gv_update" Text="Update" OnClick="gv_update_Click" CausesValidation="false" CssClass="btn btn-primary btn-sm " runat="server"></asp:LinkButton>&nbsp
...
<%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Please Enter Term 1" ControlToValidate="txt_term_1" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
...
<%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="Please Enter Condition 1" ControlToValidate="txt_condition_1" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
...
<%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="Please Enter Term 2"  ForeColor="Red" ControlToValidate="txt_term_2" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
...
<%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="Please Enter Condition 2" ControlToValidate="txt_condition_2" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
