        ...
        <div class="col-lg-12">
            <div class="card shadow-sm mb-4">
                <div class="row">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="margin-left: 60%;">
                        <asp:Button ID="btncreate1" runat="server" class="btn btn-primary btncreate" CausesValidation="False" Text="Back To Enquiry List" Visible="false" OnClick="btncreate_Click"></asp:Button>
                    </div>
                </div>
            <div class="card-body">
                <div class="row">
