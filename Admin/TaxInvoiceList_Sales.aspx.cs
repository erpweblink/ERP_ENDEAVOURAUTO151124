...
public partial class Admin_TaxInvoiceList : System.Web.UI.Page
{
    ...
    protected void GvPurchaseOrderList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Write("<script>window.open ('../reportPdf/InvoicepdfSales.aspx?Id=" + encrypt(e.CommandArgument.ToString()) + "','_blank');</script>");
        ...
        {
            Response.Redirect("TaxInvoice_Sales.aspx?Id=" + encrypt(e.CommandArgument.ToString()) + "");
        }
    ...
    {
        Response.Redirect("TaxInvoice_Sales.aspx");
    }
