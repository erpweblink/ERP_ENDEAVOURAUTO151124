<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="DebitNoteList.aspx.cs" Inherits="Admin_DebitNoteList" %>
    ...
    <form runat="server">
        ...
        <div class="col-lg-12 card">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-primary">Debit Note List</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive text-center">
                    <asp:GridView ID="gvDebitnotes" runat="server" AutoGenerateColumns="false" CssClass="grid" Width="100%" AllowPaging="true" PageSize="10" PagerStyle-CssClass="paging"  
                        OnPageIndexChanging="gvDebitnotes_PageIndexChanging" OnRowCommand="gvDebitnotes_RowCommand">
                        <Columns>
