<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="UserMasterList.aspx.cs" Inherits="Admin_UserMasterList" %>
    ...
    <form runat="server">
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm mb-4">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <asp:TextBox runat="server" class="form-control txtsear" ID="txtSearch" name="Search" placeholder="User List" onkeypress="return character(event)" />
                    ...
                    <div style="width: 100%; padding: 20px; overflow: scroll;">
                        <div class="table-responsive">
                            <asp:GridView ID="gv_user" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center"
                                OnRowCommand="gv_user_RowCommand" OnRowDataBound="gv_user_RowDataBound" OnPageIndexChanging="gv_user_PageIndexChanging" AllowPaging="true" PageSize="10" PagerStyle-CssClass="paging">
                                <Columns>
