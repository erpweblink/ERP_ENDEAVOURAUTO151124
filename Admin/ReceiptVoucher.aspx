<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ReceiptVoucher.aspx.cs" Inherits="Admin_ReceiptVoucher" %>
    ...
    <script>
        function HideLabel(msg) {
            Swal.fire({
                ...
                window.location.href = "../Admin/ReceiptVoucherDetails.aspx";
            })
        };
    </script>
    <style type="text/css">
                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 class="m-0 font-weight-bold text-primary">Receipt Voucher :</h5>
                        </div>
                        <div class="card-body">
                            <div class="row m-2">
                                <div class="col-6">
                                    <asp:Label ID="lblCustomername" runat="server" Text="Customer Name :"></asp:Label>
                                    <asp:TextBox ID="txtcustomername" AutoPostBack="true" OnTextChanged="txtcustomername_TextChanged" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-6">
                                    <asp:Label ID="lblvoucherno" runat="server" Text="Receipt Voucher No. :"></asp:Label>
                                    <asp:TextBox ID="txtReceiptvoucherno" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row m-2">
                                <div class="col-6">
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-6">
                                    <asp:Label ID="lblclearedondate" runat="server" Text="Cleared On Date :"></asp:Label>
                                    <asp:TextBox ID="txtclearedOnDate" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row m-2">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <asp:Label ID="lblchequetrasforeddate" runat="server" Text="Cheque Transfored Date :"></asp:Label>
                                    <asp:TextBox ID="txtchequetransforeddate" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    <asp:TextBox ID="txtslipno" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="row m-2">
                            <div style="width: 100%; padding: 20px;">
                                <asp:GridView ID="GvReceiptVoucher" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center"
                                    PageSize="10" AllowPaging="true" PagerStyle-CssClass="paging" OnRowDataBound="GvReceiptVoucher_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblinvoicedate" runat="server" Text='<%# Eval("InvoiceDate").ToString().TrimEnd("0:0".ToCharArray()) %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Invoice Amount">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtinvoiceamt" Width="110px" ReadOnly="true" runat="server" Text='<%# Eval("GrandTotal") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Paybal Amount">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtpaidamt" Width="110px" OnTextChanged="txtpaidamt_TextChanged" AutoPostBack="true" runat="server" Text="0.00"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Pending">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtbalance" Width="110px" ReadOnly="true" runat="server" Text="0.00"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="TDS">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtadjust" Width="110px" AutoPostBack="true"  runat="server" Text="0.00"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                        ...
                        <div class="row">
                              <div class="col-8"></div>
                             <div class="col-3">
                                <asp:Label ID="lblgrandtotal" runat="server" Text="Total Amount :"></asp:Label>
