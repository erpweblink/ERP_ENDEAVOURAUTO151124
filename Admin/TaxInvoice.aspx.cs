...
public partial class Admin_TaxInvoice : System.Web.UI.Page
{
    ...
    private void Show_Grid1()
    {
        try
        {
            ...
            Dt.Rows.Add(ViewState["RowNo"], txt_jobno.Text.Trim(), txtpoduct.Text, txt_discription.Text.Trim(), txtprintdescription.Text, txt_hsn.Text, txt_rate.Text, txt_unit.Text, txt_quntity.Text, txt_tax.Text, txt_discount.Text, txt_total_amount.Text);
            ViewState["Invoice"] = Dt;
    ...
    public void GetPODate()
    {
        ...
        SqlDataAdapter Daaa = new SqlDataAdapter("SELECT * FROM CustomerPO_Hdr WHERE Pono ='" + ddlagainstno.Text + "'  ", con);
        DataTable Dttt = new DataTable();
        Daaa.Fill(Dttt);
        if (Dttt.Rows.Count > 0)
        {
