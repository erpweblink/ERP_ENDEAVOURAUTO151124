<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AllQuotationa.aspx.cs" Inherits="Admin_Quotation_Master" %>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:TextBox runat="server" onkeypress="return isNumberKey(event)" MaxLength="13" class="form-control" ID="txt_Phoneno"></asp:TextBox>
                                    <br />
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:TextBox runat="server" class="form-control" ID="txt_state"></asp:TextBox>
                                    <br />
                                </div>
                            </div>
                            <hr />
                                ...
                                <div class="col-md-12">
                                    <table class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtadddescription" runat="server" AutoPostBack="true" Width="230px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_hsn_Tbl" runat="server" Width="100px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_rate_Tbl" AutoPostBack="true" OnTextChanged="txt_rate_Tbl_TextChanged" runat="server" Width="100px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_tax_Tbl" AutoPostBack="true" OnTextChanged="txt_tax_Tbl_TextChanged" runat="server" Width="100px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_discount_Tbl" AutoPostBack="true" OnTextChanged="txt_discount_Tbl_TextChanged" runat="server" Width="100px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                            </td>
