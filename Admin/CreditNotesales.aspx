<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="CreditNotesales.aspx.cs" Inherits="Admin_CreditNotesales" %>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header  py-3 d-flex flex-row align-items-center justify-content-between">
                    <h5 class="m-0 font-weight-bold text-primary" id="headerreport" runat="server">Credit Note(Sales Return)</h5>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Voc No" ControlToValidate="txtVocNo" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:DropDownList ID="ddldropdownlist" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Text="Credit Note/Rate Difference"></asp:ListItem>
                                    </asp:DropDownList>
                                    <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter InvoiceNo" ControlToValidate="txt_InvoiceNo" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                </div>
                            </div>
                            ...
                            <div class="row" id="invoice">
                                <div class="table-responsive text-center">
                                    <asp:GridView ID="gvPurchaseRecord" runat="server" AutoGenerateColumns="false" CssClass="grid" AllowPaging="false" Width="100%" OnRowEditing="gvPurchaseRecord_RowEditing"
                                        OnRowDataBound="gvPurchaseRecord_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Sr. No.">
                                                <ItemTemplate>
