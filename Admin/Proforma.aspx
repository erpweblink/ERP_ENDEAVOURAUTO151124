<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Proforma.aspx.cs" Inherits="Admin_Proforma" %>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header  py-3 d-flex flex-row align-items-center justify-content-between">
                    <h5 class="m-0 font-weight-bold text-primary" id="headerreport" runat="server">Proforma</h5>
                ...
                <div class="card-body">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <asp:Label ID="lbl_Invoice_no" runat="server" class="control-label col-sm-6" for="cust">Proforma No. :<span class="spncls">*</span></asp:Label>
                                ...
                                <div class="col-md-3">
                                    <asp:Label ID="lbl_InvoiceDate" runat="server" Text="" Class="control-label col-sm-6" for="cust">Proforma Date :<span class="spncls">*</span></asp:Label>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4" id="mailcheck" visible="false" runat="server">
                                <center>
