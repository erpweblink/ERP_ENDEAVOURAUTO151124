...
<head runat="server">
    <meta charset="UTF-8" />
    <title> Automation - 404 Page</title>
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css" />
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css' />
    <link rel="stylesheet" href="Admin/css/ruang-admin.css" />
</head>



<body runat="server" style="background-color:whitesmoke">
    ...
    <br />
    <main>
        <div runat="server" class="container" style="background-color:aqua">
            <div class="row">
          ...
          to go back to the homepage.                                   
                    ...
                    <p style="font-size: 14px;font-style: italic;">
                        Try to contact Devlopment Team, Thank You.
                    </p>                    
          <%--          <button class="btn green" >HOME</button>--%>
<button class="btn green" onclick="window.location.href='/Admin/Dashboard.aspx';">HOME</button>
                 
                      <pre class="stack-trace" id="stackTrace" runat="server"></pre>
                </div>
                <div class="col-md-12">
                     <asp:Label ID="lblErrorMessage" runat="server" Text="" ForeColor="aqua" Font-Size="X-Small"></asp:Label>
                </div>
            </div>
        </div>
    </main>
