...
public partial class QuatationPdf : System.Web.UI.Page
{
    ...
    //        float[] widths3 = new float[] { 4f, 12f, 12f, 10f, 8f, 8f, 8f, 11f, 8f, 12f };
    //        table.SetWidths(widths3);

    //        double Ttotal_price = 0;
    //        double Ttotal_priceByProduct = 0;
    //        SqlDataAdapter Daa = new SqlDataAdapter("SELECT distinct(product),[ID],[Quotation_no],[CompName],[HSN],[Tax],[Qty],[Units],[Rate],[total],[Disc_per],[FTotal],[Description],[JobNo] FROM [DB_EndeAuto].[dbo].[tbl_Quotation_Dtl]  WHERE Quotation_no ='" + Quo_NO + "'  ", con);
    ...
    //            SqlDataAdapter Daaa = new SqlDataAdapter("SELECT distinct(product) FROM [DB_EndeAuto].[dbo].[tbl_Quotation_Dtl]  WHERE Quotation_no ='" + Quo_NO + "'  ", con);
    ...
    //                {
    //                    if (dr["product"].ToString() == drr[ "product"].ToString())
    //                    {
    //                        double Ftotal = Convert.ToDouble(drr["total"].ToString());
    //                        string _ftotal = Ftotal.ToString("##.00");
    //                        table.AddCell(new Phrase(rowid.ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase("     " +drr[ "product"].ToString(), FontFactory.GetFont("Arial", 9)));                          
    //                        table.AddCell(new Phrase("     "+drr["Description"].ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase("     " + drr["HSN"].ToString(), FontFactory.GetFont("Arial", 9)));                    
    //                        table.AddCell(new Phrase("     " + drr["Tax"].ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase("     " + drr["Qty"].ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase("     " + drr["Units"].ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase("     " + drr["Rate"].ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase("     " + drr["Disc_per"].ToString(), FontFactory.GetFont("Arial", 9)));
    //                        table.AddCell(new Phrase(_ftotal, FontFactory.GetFont("Arial", 9)));

    //                        rowid++;
    //                        Ttotal_price += Convert.ToDouble( drr["Alltotal"].ToString());                    
    //                    }                    
    //                }
    ...
    //            //Paragraph paragraphTable22 = new Paragraph();
    //            //paragraphTable2.SpacingAfter = 5f;
    //            //table = new PdfPTable(2);
    //            //table.TotalWidth = 560f;
    //            //table.LockedWidth = true;

    //            //table.SetWidths(new float[] { 0f, 88f });
    //            //table.AddCell(paragraphTable22);
    //            //PdfPCell cell666 = new PdfPCell(new Phrase("TEST ROW", FontFactory.GetFont("Arial", 10, Font.BOLD)));
    ...
    //        table.TotalWidth = 560f;
    //        table.LockedWidth = true;
    //        table.SetWidths(new float[] { 4f, 12f, 12f, 10f, 8f, 8f, 8f, 11f, 8f, 12f });
    //        table.AddCell(paragraph);
    //        table.AddCell(new Phrase("", FontFactory.GetFont("Arial", 10, Font.BOLD)));
    //        table.AddCell(new Phrase("", FontFactory.GetFont("Arial", 10, Font.BOLD)));
    //        table.AddCell(new Phrase("", FontFactory.GetFont("Arial", 10, Font.BOLD)));
