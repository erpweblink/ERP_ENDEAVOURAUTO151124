...
public partial class Admin_Customer_PO_Sales : System.Web.UI.Page
{
    ...
    {
        DataTable Dt = new DataTable();
        //SqlDataAdapter da = new SqlDataAdapter("select CustomerPO_Dtls_Sales.JobNo,CustomerPO_Dtls_Sales.Quotationno,CustomerPO_Hdr_Sales.Id,CustomerPO_Hdr_Sales.JobNo,CustomerPO_Hdr_Sales.ShippingAddress,CustomerName,SubCustomer,Pono,PoDate,RefNo,Mobileno,KindAtt,DeliveryAddress,EmailId,GstNo,VehicelNo,PayTerm,Cgst,Sgst,Igst,AllTotalPrice,TotalInWord, RoundOff, GrandTotal, Term_Condition_1, Term_Condition_2, Term_Condition_3, Term_Condition_4, Description, Hsn_Sac,Rate,Unit,Quantity, TaxPercenteage, DiscountPercentage, Total,statecode from CustomerPO_Hdr_Sales INNER JOIN CustomerPO_Dtls_Sales ON CustomerPO_Hdr_Sales.Id = CustomerPO_Dtls_Sales.PurchaseId WHERE CustomerPO_Hdr_Sales.Id='" + ID + "'", con);
        SqlDataAdapter da = new SqlDataAdapter("select CustomerPO_Dtls_Sales.JobNo,CustomerPO_Dtls_Sales.MateName,CustomerPO_Dtls_Sales.PrintDescription,CustomerPO_Dtls_Sales.Quotationno,CustomerPO_Hdr_Sales.Id,CustomerPO_Hdr_Sales.JobNo,CustomerPO_Hdr_Sales.ShippingAddress,CustomerName,SubCustomer,Pono,PoDate,RefNo,Mobileno,KindAtt,DeliveryAddress,EmailId,GstNo,VehicelNo,PayTerm,Cgst,Sgst,Igst,AllTotalPrice,TotalInWord, RoundOff, GrandTotal, Term_Condition_1, Term_Condition_2, Term_Condition_3, Term_Condition_4,Term_Condition_5,Term_Condition_6, Description, Hsn_Sac,Rate,Unit,Quantity, TaxPercenteage, DiscountPercentage, Total,statecode from CustomerPO_Hdr_Sales INNER JOIN CustomerPO_Dtls_Sales ON CustomerPO_Hdr_Sales.Id = CustomerPO_Dtls_Sales.PurchaseId WHERE CustomerPO_Hdr_Sales.Id='" + ID + "'", con);
        da.Fill(Dt);
        ...
        DataTable Dtproduct = new DataTable();
        SqlDataAdapter daa = new SqlDataAdapter("SELECT JobNo,MateName,Description,MateName,Hsn_Sac,Rate,Unit,Quantity,TaxPercenteage,DiscountPercentage,Total FROM CustomerPO_Dtls_Sales WHERE Id='" + hdnID.Value + "' ", con);
        // SqlDataAdapter daa = new SqlDataAdapter("SELECT * FROM CustomerPO_Dtls_Sales WHERE Id='" + hdnID.Value + "' ", con);
        da.Fill(Dtproduct);
    ...
    private void Save_Record()
    {
        ...
        {
            SqlCommand Cmd = new SqlCommand("UPDATE CustomerPO_Hdr_Sales SET Quotationno=@Quotationno,CustomerName=@CustomerName,SubCustomer=@SubCustomer,Pono=@Pono,PoDate=@PoDate,RefNo=@RefNo,Mobileno=@Mobileno,KindAtt=@KindAtt,ShippingAddress=@ShippingAddress,DeliveryAddress=@DeliveryAddress,GstNo=@GstNo,Cgst=@Cgst,Sgst=@Sgst,Igst=@Igst,AllTotalPrice=@AllTotalPrice,RoundOff=@RoundOff,GrandTotal=@GrandTotal,TotalInWord=@TotalInWord,Is_Deleted=@Is_Deleted,PayTerm=@PayTerm,Term_Condition_1=@Term_Condition_1,Term_Condition_2=@Term_Condition_2,Term_Condition_3=@Term_Condition_3,Term_Condition_4=@Term_Condition_4,statecode=@statecode,UpdatedBy=@UpdatedBy,UpdatedOn=@UpdatedOn WHERE Id='" + hdnID.Value + "'", con);
            ...
            SqlCommand cmddelete = new SqlCommand("DELETE FROM CustomerPO_Dtls_Sales WHERE PurchaseId=@PurchaseId", con);
            ...
            foreach (GridViewRow g2 in gvPurchaseRecord.Rows)
            {
               ...
               // string MateName = (g2.FindControl("txt_printdescription_grd") as Label).Text;
                ...
                SqlCommand Cmd1 = new SqlCommand("INSERT INTO CustomerPO_Dtls_Sales (PurchaseId,Hsn_Sac,TaxPercenteage,Quantity,Unit,Rate,DiscountPercentage,Total, PrintDescription, MateName,Quotationno) " +"VALUES('" + hdnID.Value + "','" + HSN + "','" + Tax + "','" + Quntity + "','" + Unit + "','" + Rate + "','" + Discount + "','" + Total_Amount + "','" + PrintDescription + "', '" + MateName + "', '" + ddlquotationno.SelectedItem.Text + "')", con);
        ...
        else
        {
            try
            {
                SqlCommand Cmd = new SqlCommand("SP_CustomerPO_Sales", con);
              ...
              //  Cmd.Parameters.AddWithValue("@JobNo", txt_job_no.Text);
                ...
                foreach (GridViewRow g1 in gvPurchaseRecord.Rows)
                {
                   ...
                   // string Discription = (g1.FindControl("txt_discription_grd") as Label).Text;
                    ...
                    SqlCommand Cmd1 = new SqlCommand("INSERT INTO CustomerPO_Dtls_Sales (PurchaseId,Description,Hsn_Sac,TaxPercenteage,Quantity,Unit,Rate,DiscountPercentage,Total,JobNo,PrintDescription,MateName,Quotationno) " +
                ...
                foreach (GridViewRow g1 in quatationgrid.Rows)
                {
                   ...
                   // string Discription = (g1.FindControl("txt_discription_grd") as Label).Text;
                    ...
                    SqlCommand Cmd1 = new SqlCommand("INSERT INTO CustomerPO_Dtls_Sales (PurchaseId,Hsn_Sac,TaxPercenteage,Quantity,Unit,Rate,DiscountPercentage,Total,MateName,PrintDescription,Quotationno) " +
                         "VALUES('" + id + "','" + HSN + "','" + Tax + "','" + Quntity + "','" + Unit + "','" + Rate + "','" + Discount + "','" + Total_Amount + "','" + MateName + "' ,'" + PrintDescription + "','" + ddlquotationno.SelectedItem.Text + "')", con);
                    Cmd1.ExecuteNonQuery();
                }
                foreach (GridViewRow g1 in Grd_MAIL.Rows)
